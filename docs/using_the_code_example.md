...
The following example clones the "[EPC4 TF-M Crypto](https://github.com/Infineon/mtb-example-psoc-edge-epc4-tfm-crypto)" application with the desired name "Epc4TfmCrypto" configured for the *KIT_PSE84_EVAL_EPC4* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC4 --app-id mtb-example-psoc-edge-epc4-tfm-crypto --user-app-name Epc4TfmCrypto --target-dir "C:/mtb_projects"
   ```
